...
Item {
	...
	component Bar: JsonObject {
		...
		property string defaultAppName: "Aureli" // When no toplevel is focused it will show this text. Ideas: "Equora" | "eqSh" | "Hyprland" | "YOURUSERNAME"
		// Example dateFormats:
		// DEFAULT:
		//     ddd, dd MMM HH:mm
		// USA:
	...
	component LockScreen: JsonObject {
		...
		property string       customWallpaperPath: "/usr/share/aureli/Star-Lens.jpg"
	...
	component Wallpaper: JsonObject {
		...
		property string path: "/usr/share/aureli/Star-Lens.jpg"
		property bool   enableShader: false
